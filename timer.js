document.addEventListener('DOMContentLoaded',()=>{
  ...
  style.textContent=`.study-timer{position:fixed;right:max(16px,env(safe-area-inset-right));bottom:max(16px,env(safe-area-inset-bottom));z-index:1000;width:min(560px,calc(100% - 32px));margin:0;padding:14px 16px;border:1px solid #b9cabf;border-radius:14px;background:#e9efe9;box-shadow:0 12px 32px #18231e33;display:flex;justify-content:space-between;align-items:center;gap:14px;flex-wrap:wrap}.study-timer strong{display:block;font:600 2rem Georgia;color:#18231e;letter-spacing:.04em}.timer-controls{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.timer-controls label{font-weight:800;color:#245b48}.timer-controls input{width:64px;padding:8px;border:1px solid #9ab3a8;border-radius:9px;background:#fff;font:inherit}.timer-controls button{padding:9px 13px}.timer-start{background:#245b48;color:#fff;border-color:#245b48}.timer-preset.active{background:#d8e6dc;color:#245b48;border-color:#8caf9c}@media(max-width:620px){.study-timer{align-items:flex-start}.timer-controls{width:calc(100% - 24px);right:12px;bottom:max(12px,env(safe-area-inset-bottom))}.timer-controls{width:100%}}`;
